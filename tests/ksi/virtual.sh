...
docker --log-level ERROR compose exec spark-iceberg sh -c "cat /tmp/$TEST_FILE | spark-shell --driver-memory 8g --packages org.scalatest:scalatest_2.13:3.2.19,org.apache.kafka:kafka-clients:4.1.0"
