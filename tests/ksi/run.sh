...
docker --log-level ERROR compose exec spark-iceberg sh -c "cat /tmp/$TEST_FILE | spark-shell --driver-memory 8g --packages org.scalatest:scalatest_2.12:3.0.6,org.apache.kafka:kafka-clients:4.1.0"