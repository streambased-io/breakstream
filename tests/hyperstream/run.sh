...
PACKAGES="org.scalatest:scalatest_2.13:3.2.19,net.liftweb:lift-json_2.13:3.5.0,com.softwaremill.sttp.client4:core_2.13:4.0.13"
...
docker --log-level ERROR compose exec spark-iceberg sh -c "cat /tmp/$COMMON_FILE /tmp/$SUBSTR_SUITE_FILE > /tmp/$SUBSTR_TEST_FILE"
