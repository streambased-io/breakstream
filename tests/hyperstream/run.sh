...
docker --log-level ERROR compose exec spark-iceberg sh -c "cat /tmp/$TEST_FILE | spark-shell --driver-memory 8g --conf spark.ui.enabled=false  --packages org.scalatest:scalatest_2.12:3.0.6,net.liftweb:lift-json_2.12:3.5.0,com.softwaremill.sttp.client4:core_2.12:4.0.13"
